                ...
                if let r = results.first as? NSManagedObject{
                    ...
                    if totalXP >= 0.0 && totalXP <= 1.0{
                        if totalXP >= 0.0 && totalXP < 0.10{
                            self.xpUser = 1
                            self.niveauProgression.setProgress(totalXP/0.1, animated: true)
                            self.nivMin.text = "nv.1"
                            self.nivMax.text = "nv.2"
                        }
                        else if totalXP >= 0.1 && totalXP < 0.2{
                            self.xpUser = 2
                            self.niveauProgression.setProgress((totalXP/0.2)/2.0, animated: true)
                            self.nivMin.text = "nv.2"
                            self.nivMax.text = "nv.3"
                        }
                        else if totalXP >= 0.2 && totalXP < 0.3{
                            self.xpUser = 3
                            self.niveauProgression.setProgress((totalXP/0.3)/2.0, animated: true)
                            self.nivMin.text = "nv.3"
                            self.nivMax.text = "nv.4"
                        }
                        else if totalXP >= 0.3 && totalXP < 0.5{
                            self.xpUser = 4
                            self.niveauProgression.setProgress((totalXP/0.5)/2.0,animated: true)
                            ...
                            self.xpUser = 5
                            self.niveauProgression.setProgress((totalXP/0.75)/2.0, animated: true)
                            self.nivMin.text = "nv.5"
                            self.nivMax.text = "nv.6"
                        }
                        else if totalXP >= 0.75 && totalXP < 1.0{
                            self.xpUser = 6
                            self.niveauProgression.setProgress((totalXP/1.0)/2.0,animated: true)
                            self.nivMin.text = "nv.6"
                            self.nivMax.text = "nv.MAX"
                        }
                        else{
                            self.xpUser = 7
                            self.niveauProgression.setProgress(1.0,animated: true)
                            self.nivMin.text = "nv.6"
                            self.nivMax.text = "nv.MAX"
                        }
                    }
